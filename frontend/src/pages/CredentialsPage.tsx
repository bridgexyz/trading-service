...
export default function CredentialsPage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      {showForm && (
        <div className="bg-surface-1 border border-border-default rounded-lg p-5 space-y-4 animate-fade-up">
          ...
          <div className="flex flex-wrap gap-3">
            <div>
              ...
              <input
                ...
                className="bg-surface-2/80 border border-border-default rounded-md px-3 py-2 text-[13px] font-mono text-text-primary placeholder:text-text-muted hover:border-border-hover focus:border-accent/40 focus:outline-none transition-all w-36"
              />
            </div>
            <div>
              <label className="text-[10px] text-text-muted uppercase tracking-[0.12em] block mb-1.5 font-mono">
              ...
              <input
                ...
                className="bg-surface-2/80 border border-border-default rounded-md px-3 py-2 text-[13px] font-mono text-text-primary placeholder:text-text-muted hover:border-border-hover focus:border-accent/40 focus:outline-none transition-all w-80"
              />
            </div>
            <div>
              <label className="text-[10px] text-text-muted uppercase tracking-[0.12em] block mb-1.5 font-mono">
            ...
            <div>
              ...
              <input
                ...
                placeholder="0x..."
                className="bg-surface-2/80 border border-border-default rounded-md px-3 py-2 text-[13px] font-mono text-text-primary placeholder:text-text-muted/30 hover:border-border-hover focus:border-accent/40 focus:outline-none transition-all w-80"
              />
            </div>
          </div>
          {error && (
      ...
      <div className="space-y-2">
        {creds?.map((cred) => (
          <div
            key={cred.id}
            className="bg-surface-1 border border-border-default rounded-lg px-5 py-4 card-hover"
          >
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div>
                <div className="flex items-center gap-2.5">
                  <div className="w-7 h-7 rounded-md bg-accent/8 border border-accent/15 flex items-center justify-center">
              ...
              <div className="flex gap-1.5 ml-9.5 sm:ml-0">
                <button
                  ...
                  className="text-[11px] font-mono bg-surface-2 hover:bg-surface-3 border border-border-default hover:border-border-hover text-text-secondary hover:text-text-primary px-3 py-2 rounded-md transition-all min-h-[44px] sm:min-h-0"
                >
                ...
                <button
                  ...
                  className="text-[11px] font-mono text-negative hover:bg-negative/8 border border-transparent hover:border-negative/20 px-3 py-2 rounded-md transition-all min-h-[44px] sm:min-h-0"
                >
                  DELETE
                </button>
              </div>
        ...
        {(!creds || creds.length === 0) && (
          <div className="bg-surface-1 border border-border-default rounded-lg py-16 text-center">
            <div className="w-10 h-10 rounded-lg bg-surface-2 border border-border-default flex items-center justify-center mx-auto mb-3">
        ...
        {testMut.data && (
          <div className="bg-surface-2/50 border border-border-default rounded-lg p-4 text-xs font-mono text-text-secondary">
