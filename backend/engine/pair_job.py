...
async def _execute_chunked_orders(
    ...
    """Delegate to shared order executor with pair-specific config."""
    from backend.engine.order_executor import execute_chunked_pair_orders

    return await execute_chunked_pair_orders(
        client=client,
        ...
        is_ask_a=is_ask_a,
        is_ask_b=is_ask_b,
        chunks=pair.slice_chunks,
        delay_sec=pair.slice_delay_sec,
